# Guide de Démarrage Rapide - Project Echo
...
1. **Comptes:**
   - GitHub (gratuit)
   - DigitalOcean (vous avez $200 de crédits)
...
### Option 1: Déploiement DigitalOcean App Platform (Le Plus Simple)
...
#### Étape 6: Créer DigitalOcean Spaces
...
### Option 2: Déploiement Droplet (Plus Économique)
...
Créez et exécutez ce script sur votre machine locale:
...
# Créer le fichier .env backend (vous devrez le compléter)
...
2. **Configurer le Scraping:**
   ...
   - Définissez les filtres de contenu
   - Configurez le planning de publication

3. **Tester:**
   - Allez dans "Queue"
   - Le système va automatiquement scraper et traiter des vidéos
   - Surveillez le processus

### 3. Activer Phase 2 (Quand Prêt)
...
1. ✅ Déployer (suivez Option 1 ou 2 ci-dessus)
2. ✅ Configurer votre première chaîne
3. ✅ Tester avec une vidéo
4. ✅ Monitorer via Dashboard
5. ✅ Activer Phase 2 quand prêt
